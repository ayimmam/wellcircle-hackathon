      ...
      <div className="feed">
        {leaderboard.map((u, i) => (
          <div key={u.user_id} className="cell">
            ...
            <div className="avatar avatar-md" style={{ cursor: 'pointer' }} onClick={() => navigate(`/users/${u.user_id}`)}>
              <SmartImage
            ...
            <div className="cell-body cell-title" style={{ cursor: 'pointer' }} onClick={() => navigate(`/users/${u.user_id}`)}>{u.name}</div>
