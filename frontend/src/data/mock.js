...
export const MOCK_PROVIDERS = [
  ...
  // ─── Sep 23 - Oct 3, 2026 poster clubs (docs/Event Schedule & Bot Data.docx,
  // cross-checked against events/sep21.jpg + events/sep 21 (1).jpg) ───
  // All brand-new hosts, so coming-soon like backend/seed_events_sep23_oct3.py
  // seeds them — no cropped cover approved yet, so cover_photo_url stays null
  // (SmartImage/FeedEventBanner already handle that).
  {
    id: '11111111-0000-0000-0000-000000000016',
    name: 'Zumba with Vahe',
    category: 'gym',
    is_coming_soon: true,
    description: 'Zumba with Vahe — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    location_text: 'Sup Studio / Armenian Club, Addis Ababa',
    lat: null, lng: null,
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000016', name: 'Zumba with Vahe', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000016'
  },
  {
    id: '11111111-0000-0000-0000-000000000017',
    name: 'Debol Running Club',
    category: 'running',
    is_coming_soon: true,
    description: 'Debol Running Club — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000017', name: 'Debol Running Club', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000017'
  },
  {
    ...
    category: 'yoga',
    is_coming_soon: true,
    description: 'Khul Wholeness Center — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    location_text: 'Khul Wholeness Center, Addis Ababa',
    lat: null, lng: null,
    price_range: 'Price on request',
    rating: null,
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000018', name: 'Khul Wholeness Center', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000018'
  },
  {
    ...
    category: 'other',
    is_coming_soon: true,
    description: 'Ereft Ethiopia — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    location_text: 'Addis Ababa',
    lat: null, lng: null,
    price_range: 'Price on request',
    rating: null,
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000019', name: 'Ereft Ethiopia', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000019'
  },
  {
    id: '11111111-0000-0000-0000-000000000020',
    name: 'Guzo Adwa Hiking',
    category: 'other',
    is_coming_soon: true,
    description: 'Guzo Adwa Hiking — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    location_text: 'Addis Ababa',
    lat: null, lng: null,
    price_range: 'Price on request',
    rating: null,
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000020', name: 'Guzo Adwa Hiking', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000020'
  },
  {
    ...
    category: 'other',
    is_coming_soon: true,
    description: 'Borena Tour — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    location_text: 'Addis Ababa',
    lat: null, lng: null,
    price_range: 'Price on request',
    rating: null,
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000021', name: 'Borena Tour', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000021'
  },
  {
    ...
    category: 'other',
    is_coming_soon: true,
    description: 'Addis Hiking — community group posted on the @wellcircle Sep 23-Oct 3 events posters.',
    location_text: 'Bonga',
    lat: null, lng: null,
    price_range: 'Price on request',
    rating: null,
    ...
    photos: [],
    services: [],
    community: { id: '22222222-0000-0000-0000-000000000022', name: 'Addis Hiking', member_count: 0, user_joined: false },
    member_count: 0,
    community_id: '22222222-0000-0000-0000-000000000022'
  }
];
...
const POSTER_EVENTS = [
  ...
  // ─── Sep 23 - Oct 3, 2026 poster clubs. Kept in sync with
  // backend/seed_events_sep23_oct3.py — same providers, dates, prices and
  // descriptions (which fold in location/pricing/contact prose since
  // provider_events has no location_text column on the backend). ───
  {
    id: 'evt-bertusew-sep23',
    provider_id: '11111111-0000-0000-0000-000000000015',
    provider_name: 'Bertusew Runningclub',
    provider_category: 'running',
    provider_cover_photo_url: 'https://images.unsplash.com/photo-1502904550040-7534597429ae?w=800',
    service_name: 'Bertusew Running Club',
    description: 'Free community morning run at Yetebaberut Square Sport Center, CMC. Contact: 0947537473 | Telegram Channel: @bertusewfitness',
    price_etb: 0, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-23T03:45:00Z',
  },
  {
    id: 'evt-bertusew-sep27',
    provider_id: '11111111-0000-0000-0000-000000000015',
    provider_name: 'Bertusew Runningclub',
    provider_category: 'running',
    provider_cover_photo_url: 'https://images.unsplash.com/photo-1502904550040-7534597429ae?w=800',
    ...
    description: 'Free community morning run at Yetebaberut Square Sport Center, CMC. Contact: 0947537473 | Telegram Channel: @bertusewfitness',
    price_etb: 0, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-27T03:45:00Z',
  },
  {
    id: 'evt-vahe-sep23',
    provider_id: '11111111-0000-0000-0000-000000000016',
    provider_name: 'Zumba with Vahe',
    provider_category: 'gym',
    provider_cover_photo_url: null,
    service_name: 'Zumba with Vahe — Wed',
    description: 'High-energy Zumba session with Vahe at Sup Studio, Addis Ababa. Drop-in: 1,500 ETB · 6-Pack: 5,700 ETB (save 25%) · Monthly Unlimited: 7,500 ETB/month (35% discount, includes access to any class at any venue). Contact: 0911882287 | Instagram: @vahetilbian',
    price_etb: 1500, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-23T15:15:00Z',
  },
  {
    id: 'evt-vahe-sep26',
    provider_id: '11111111-0000-0000-0000-000000000016',
    ...
    provider_category: 'gym',
    provider_cover_photo_url: null,
    service_name: 'Zumba with Vahe — Sat',
    description: 'High-energy Zumba session with Vahe at Sup Studio, Addis Ababa. Drop-in: 1,500 ETB · 6-Pack: 5,700 ETB (save 25%) · Monthly Unlimited: 7,500 ETB/month (35% discount, includes access to any class at any venue). Contact: 0911882287 | Instagram: @vahetilbian',
    price_etb: 1500, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
  ...
  },
  {
    ...
    provider_category: 'gym',
    provider_cover_photo_url: null,
    service_name: 'Zumba with Vahe — Mon',
    description: 'High-energy Zumba session with Vahe at Armenian Club, Addis Ababa. Drop-in: 1,500 ETB · 6-Pack: 5,700 ETB (save 25%) · Monthly Unlimited: 7,500 ETB/month (35% discount, includes access to any class at any venue). Contact: 0911882287 | Instagram: @vahetilbian',
    price_etb: 1500, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-28T15:15:00Z',
  },
  {
    id: 'evt-debol-sep23',
    provider_id: '11111111-0000-0000-0000-000000000017',
    provider_name: 'Debol Running Club',
    provider_category: 'running',
    provider_cover_photo_url: null,
    service_name: 'Debol Running Club — Social 5K',
    description: 'Free social 5K run, meeting at Megenagna, Addis Ababa. Website: debolrunningclub.com',
    price_etb: 0, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-23T15:30:00Z',
  },
  {
    id: 'evt-debol-sep27',
    provider_id: '11111111-0000-0000-0000-000000000017',
    ...
    provider_cover_photo_url: null,
    service_name: 'Debol Running Club — Social 5K',
    description: 'Free social 5K run, meeting at Friendship Park, Addis Ababa. Website: debolrunningclub.com',
    price_etb: 0, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-27T03:30:00Z',
  },
  {
    id: 'evt-khul-sep23',
    provider_id: '11111111-0000-0000-0000-000000000018',
    provider_name: 'Khul Wholeness Center',
    provider_category: 'yoga',
    provider_cover_photo_url: null,
    service_name: 'Inner Recharge with Yoftahe (YT)',
    description: 'A session to pause, breathe, and reconnect at Khul Wholeness Center: mind and body relaxing exercises, space to observe feelings and connect with like-minded individuals, and a herbal tea relaxing experience. Fixed schedule every Wednesday. Pricing: 500 ETB in advance (before the day) · 600 ETB on the day · 2,000 ETB/month Dedicated Pass (4 Wednesdays). Registration: 0932333382 | Telegram: @khulservice (send Name, Phone Number & #ውስጣዊእድሳት)',
    price_etb: 500, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-23T14:45:00Z',
  },
  {
    id: 'evt-khul-sep30',
    provider_id: '11111111-0000-0000-0000-000000000018',
    ...
    description: 'A session to pause, breathe, and reconnect at Khul Wholeness Center: mind and body relaxing exercises, space to observe feelings and connect with like-minded individuals, and a herbal tea relaxing experience. Fixed schedule every Wednesday. Pricing: 500 ETB in advance (before the day) · 600 ETB on the day · 2,000 ETB/month Dedicated Pass (4 Wednesdays). Registration: 0932333382 | Telegram: @khulservice (send Name, Phone Number & #ውስጣዊእድሳት)',
    price_etb: 500, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-30T14:45:00Z',
  },
  {
    id: 'evt-satenaw-sep24',
    provider_id: '11111111-0000-0000-0000-000000000014',
    provider_name: 'Satenaw Runclub',
    provider_category: 'running',
    provider_cover_photo_url: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=800',
    service_name: 'Satenaw Run Club',
    description: 'Community evening run at Friendship Park. 150 ETB Friendship Park entrance fee applies. Contact: 0941545953 | Telegram Channel: @satenaw_runclub',
    price_etb: 150, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-24T14:45:00Z',
  },
  {
    id: 'evt-satenaw-sep27',
    provider_id: '11111111-0000-0000-0000-000000000014',
    provider_name: 'Satenaw Runclub',
    provider_category: 'running',
    provider_cover_photo_url: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=800',
    service_name: 'Satenaw Run Club',
    description: 'Free community morning run from Filwuha Bridge. Contact: 0941545953 | Telegram Channel: @satenaw_runclub',
    price_etb: 0, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-27T03:30:00Z',
  },
  {
    id: 'evt-ereft-sep25',
    provider_id: '11111111-0000-0000-0000-000000000019',
    provider_name: 'Ereft Ethiopia',
    provider_category: 'other',
    provider_cover_photo_url: null,
    service_name: 'Gurage Special Meskel Trip',
    description: 'Meskel trip, meeting point Addis Ababa. Pricing: Single 29,000 ETB · Couples 27,000 ETB per person · 10% group discount. Includes tourist bus transport, full board meals, traditional lodge stay, Yerere Waterfall, monastery visit & Demera ceremony. Contact: 0927928407 / 0966752720 | Social: @ereft_ethiopia',
    price_etb: 29000, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-25T02:30:00Z',
  },
  {
    id: 'evt-guzoadwa-sep25',
    provider_id: '11111111-0000-0000-0000-000000000020',
    provider_name: 'Guzo Adwa Hiking',
    provider_category: 'other',
    provider_cover_photo_url: null,
    service_name: 'Merete-Wegeram Village Meskel Trip',
    description: 'Meskel trip to Merete-Wegeram Village, meeting point Addis Ababa. Pricing: Regular / Foreigners 24,000 ETB (early-bird window closed). Includes highway transport, full meals, traditional village hut/camping, mountain hike, cultural slaughtering ceremony, Kitfo feast & Demera bonfire. Contact: 0942545470 | Social: @guzo_adwa_hiking',
    price_etb: 24000, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-25T03:00:00Z',
  },
  {
    id: 'evt-borena-sep26',
    provider_id: '11111111-0000-0000-0000-000000000021',
    provider_name: 'Borena Tour',
    provider_category: 'other',
    provider_cover_photo_url: null,
    service_name: 'Gurage Community Trip',
    description: 'Nature-soft and cultural tour, meeting point Addis Ababa. 22,000 ETB, includes accommodation, meals, transportation, bottled water, hot drinks (coffee & tea) and guide fee (excludes personal expenses and alcoholic beverages). Discover the culture, traditions and faith of the Gurage people: traditional cultural dances, authentic culinary experiences (ox purchase, preparation of raw meat, Kitfo, and Kocho) and hands-on cultural activities. Contact: 0939616163',
    price_etb: 22000, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
    starts_at: '2026-09-26T03:00:00Z',
  },
  {
    id: 'evt-addishiking-sep30',
    provider_id: '11111111-0000-0000-0000-000000000022',
    provider_name: 'Addis Hiking',
    provider_category: 'other',
    provider_cover_photo_url: null,
    service_name: 'Coffee Day — Bonga Trip',
    description: '4 Days / 3 Nights Coffee Day celebration, meeting point Bonga. 19,300 ETB per person — includes transportation within Bonga, all meals, drinks (water, tea & coffee), accommodation, local guide, entrance fees. Excludes transportation from Addis Ababa to Bonga and back (participants can select bus or flight). Itinerary: Day 1 — Arrival in Bonga: meet group at 5:00 PM, check-in, settle into Guest House. Day 2 — Wushwush & Barta Waterfall: visit Wushwush Tea Farm, hike to Barta Waterfall, traditional Ethiopian coffee ceremony, overnight campfire. Day 3 — Mankira & Ye Egzer Dildiy: visit Mankira Coffee Forest, explore Ye Egzer Dildiy, visit Abaynesh Farm, overnight stay. Day 4 — Return to Addis Ababa: depart Bonga by public transport; end of trip. Contact: 0920807230 | Social: @addishiking',
    price_etb: 19300, capacity: 50, spots_remaining: 50, urgency: 'low', is_boosted: true,
